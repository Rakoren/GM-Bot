...
if (!manifestPath) {
  console.error("Usage: node tools/check-sourceref-ch5.mjs <path-to-manifest.json>");
  process.exit(2);
}
...
const mustHaveTypes = new Set(["feat", "table"]);
let ok = true;
...
console.log("sourceRef check OK (Chapter 5)");
