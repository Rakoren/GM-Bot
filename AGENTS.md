...
- `ADMIN_CORS_ORIGINS` (optional, comma-separated origins allowed for admin API)
- `APP_DB_PATH` (optional, default `data/app.sqlite`)
- `BACKUP_DIR` (optional, default `data/backups`)
- `BACKUP_KEEP` (optional, default `10`)
- `BACKUP_INTERVAL_MIN` (optional, default `1440`, set `0` to disable)
- `ADMIN_SESSION_SECRET` (recommended)
- `ADMIN_SESSION_IDLE_MS` (optional, default `7200000`)
- `ADMIN_CSRF_ENABLED` (optional, default `true`)
- `ADMIN_RATE_LIMIT_WINDOW_MS` (optional, default `60000`)
- `ADMIN_RATE_LIMIT_MAX` (optional, default `120`)
- `ADMIN_AUTH_RATE_LIMIT_MAX` (optional, default `30`)
- `ADMIN_UPLOAD_MAX_MB` (optional, default `15`)
- `ADMIN_GZIP_ENABLED` (optional, default `true`)
- `ADMIN_GZIP_MIN_BYTES` (optional, default `512`)
- `BOT_HEALTH_HOST` (optional, default `127.0.0.1`)
- `BOT_HEALTH_PORT` (optional, default `3099`)
- `LOG_DIR` (optional, default `logs`)
- `LOG_LEVEL` (optional, default `info`)
- `LOG_MAX_BYTES` (optional, default `5242880`)
- `LOG_MAX_FILES` (optional, default `5`)
- `BUILD_ID` (optional, default timestamp at startup)
